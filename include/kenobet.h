...
class KenoBet {
    public:
        ...
        KenoBet(set_of_numbers_type spots_) : m_spots(spots_), m_wage(0){};
        ...
        cash_type payoff_table(number_type total, number_type acertos);

        /*! Creates the list of hits.
            @return An vector with the rand numbers*/
        set_of_numbers_type hits(int rounds);
        ...
        void show_spots(set_of_numbers_type spots);
